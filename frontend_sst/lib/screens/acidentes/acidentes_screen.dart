...
class _AcidentesScreenState extends State<AcidentesScreen> {
  ...
  Future<void> buscarAcidentes() async {
    ...
    try {
      ...
      var url = Uri.parse("https://gestao-sst.onrender.com/api/acidentes/listar/$empresaSelecionada");
  ...
  Future<void> excluirTudo() async {
    ...
    if (confirmar) {
      setState(() => carregando = true);
      var url = Uri.parse("https://gestao-sst.onrender.com/api/acidentes/apagar-tudo/$empresaSelecionada");
  ...
  Future<void> excluirAcidente(int id) async {
    setState(() => carregando = true);
    var url = Uri.parse("https://gestao-sst.onrender.com/api/acidentes/excluir/$id");
    await http.delete(url);
    buscarAcidentes(); 
  }
