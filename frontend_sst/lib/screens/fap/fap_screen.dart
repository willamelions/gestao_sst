...
class _FapScreenState extends State<FapScreen> {
  ...
  Future<void> buscarHistorico() async {
    ...
    try {
      var url = Uri.parse("http://localhost:3000/api/fap/historico/$empresaSelecionada");
  ...
  Future<void> salvarFap() async {
    ...
    setState(() => carregando = true);
    var url = Uri.parse("http://localhost:3000/api/fap/registrar");
  ...
  Future<void> excluirFap(int id) async {
    setState(() => carregando = true);
    var url = Uri.parse("http://localhost:3000/api/fap/excluir/$id");
