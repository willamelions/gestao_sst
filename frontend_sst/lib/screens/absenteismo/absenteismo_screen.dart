...
class _AbsenteismoScreenState extends State<AbsenteismoScreen> {
  ...
  Future<void> buscarDados() async {
    ...
    try {
      var url = Uri.parse("https://gestao-sst.onrender.com/api/absenteismo/indicadores/$empresaSelecionada");
  ...
  Future<void> salvarRegistro() async {
    ...
    setState(() => carregando = true);
    var url = Uri.parse("https://gestao-sst.onrender.com/api/absenteismo/registrar");
  ...
  Future<void> excluirRegistro(int id) async {
    setState(() => carregando = true);
    await http.delete(Uri.parse("https://gestao-sst.onrender.com/api/absenteismo/excluir/$id"));
